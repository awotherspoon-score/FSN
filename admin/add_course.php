...
if(@$_POST['preview']){
	...
	if(!$error){
		...
		$add_course = mysql_query("INSERT INTO courses (course_id, course_meta_desc, course_meta_keyw, course_code, course_title, course_details, course_content, course_programme, course_discount) VALUES ('','$insert_course_meta_desc','$insert_course_meta_keyw','$insert_course_code','$insert_course_title','$insert_course_details','$insert_course_content','$insert_course_programme','')");
...
<body>
	...
	<div id="background-wrapper">
		...
		<div class="container">
			...
			<input type="submit" value="add course" name="submit" id="course_submit" />
			</div>
			</form>
