/**
 * $Id: editor_plugin_src.js,v 1.1 2008/09/06 17:43:15 skabouter Exp $
 *
 * @author Wouter van Kuipers (info@pwnd.nl)
 * @copyright Copyright ©2008, Professional Webdesign & Development, All rights reserved.
 */
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceArchiv_files', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm?type=files',
			...
			ed.addCommand('mceArchiv_images', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm?type=images',
